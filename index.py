...
def handler(event, context):
    ...
    if event['session']['new']:
        ...
        return make_response(
            text = txt, tts = "<speaker audio='dialogs-upload/05d0273d-97bb-45de-a2c5-52b00fa2ec70/54db7e77-f45c-457e-9b8a-143a0515d47c.opus'>Привет! Я расскажу тебе о расписании ВШЭ. Чтобы вызвать справку и подробнее узнать, как мной пользоваться, скажи - покажи справку.")
